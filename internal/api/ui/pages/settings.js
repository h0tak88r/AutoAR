(() => {
    ...
    el.innerHTML = `
      <div class="settings-container-premium">
        <div class="settings-section">
          <div class="settings-section-header">[WRENCH] System Status</div>
            ...
            <div class="settings-item">
              ...
              <div class="settings-value">
                <span class="badge ${cfg.auth_enabled ? 'badge-done' : 'badge-failed'}">
                  ${cfg.auth_enabled ? '[OK] Active' : '[UNLOCK] Public (Warning)'}
                </span>
              </div>
            </div>
          </div>
        ...
        <div class="settings-section">
          <div class="settings-section-header">[ROBOT] AI Intelligence</div>
          <div class="settings-section-body">
            <div class="settings-item">
              <div class="settings-label">
        ...
        <div class="settings-section">
          <div class="settings-section-header">[TIMER] Scan Phase Timeouts</div>
          ...
          <div class="settings-section-body">
            <div class="settings-timeout-grid">
              ...
              <div class="timeout-field">
                <label>[SAVE] Backup / Fuzzuli</label>
              ...
              <div class="timeout-field">
                <label>[SPIDER] Katana Crawler</label>
            ...
            <div style="margin-top: 20px; display: flex; align-items: center; gap: 15px;">
              <button class="btn btn-primary" onclick="window.SettingsPage.saveTimeoutSettings()" id="timeout-save-btn">[SAVE] Save All Timeouts</button>
        ...
        <div class="settings-section">
          <div class="settings-section-header">[BELL] Notifications</div>
          <div class="settings-section-body">
            <div class="settings-item">
              <div class="settings-label">
        ...
        <div class="settings-section">
          <div class="settings-section-header">[CLOUD] Cloudflare R2 Infrastructure</div>
          <div class="settings-section-body">
        ...
        <div class="settings-section">
          <div class="settings-section-header">[SAT] API Endpoints</div>
          <div class="settings-section-body">
  ...
  async function saveTimeoutSettings() {
    ...
    try {
      ...
      if (note) note.textContent = `[OK] Saved to DB at ${new Date().toLocaleTimeString()} — persists across redeployments`;
      try { window.state.config = await window.apiFetch('/api/config'); } catch(_) {}
    } catch (e) {
      window.showToast('error', 'Error', e.message);
    }
    if (btn) { btn.disabled = false; btn.textContent = '[SAVE] Save all timeouts'; }
  }
